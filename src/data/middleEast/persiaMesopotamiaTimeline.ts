...
export const persiaMesopotamiaTimeline: TimelineItem[] = [
  ...
  {
    year: "c. 2334–2154 BCE",
    event: "Akkadian Empire unites Mesopotamia under Sargon the Great.",
  },
  {
    year: "c. 2700–539 BCE",
    event: "Elamite Civilization flourishes in western Persia (modern Iran).",
  },
  {
    year: "c. 1894–539 BCE",
    event: "Babylonian Empire rises, Hammurabi's Code codifies laws.",
  },
  {
    year: "c. 2500–609 BCE",
    event:
