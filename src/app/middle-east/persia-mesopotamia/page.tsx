...
export default function PersiaMesopotamiaPage() {
  return (
    <main className={`space-y-16 ${theme.factsBg ?? ""}`}>
      {/* ================= HERO ================= */}
      <section className="relative w-full h-[90vh] overflow-hidden">
        ...
        <div className="relative z-20 flex items-center justify-center h-full px-4">
          <div
            className={`bg-black/40 backdrop-blur-sm text-white px-10 py-7 rounded-2xl shadow-2xl max-w-xl text-center border ${theme.heroBorder}/70`}
          >
      ...
      >
        ...
        <p
          className={`text-lg max-w-3xl mx-auto leading-relaxed mt-4 ${theme.introText}`}
        >
      ...
      <div className={`${theme.factsBg ?? ""} px-4`}>
        <RegionContent
